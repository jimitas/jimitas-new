  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          onClick={clearTable}
          className="px-3 py-2 rounded font-bold border-2 border-gray-400 text-gray-600 hover:bg-gray-100 text-sm active:scale-95 transition-all"
        >
          消す
        </button>
        <button
      ...
      <div
        ref={formulaRef}
        className="text-center font-bold text-3xl md:text-4xl py-3 px-4 bg-gradient-to-r from-white to-orange-50 rounded-xl border-2 border-orange-200 shadow-sm tracking-wider min-h-[56px] flex items-center justify-center"
      />
